...
async def createuser(ctx):
    '''takes the discord context and extracts the uni from the message and then creates the student object'''
...
async def addclass(ctx):
    '''takes the discord context and extracts class from the message, and then adds a class to the student'''
    username = str(ctx.author)
...
async def addprof(ctx):
    '''takes the discord context and extracts professor from the message, and then adds a professor to the student'''
    username = str(ctx.author)
